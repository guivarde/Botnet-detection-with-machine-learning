'''
Ce code convertit les fichiers XML d'ataset ISCX en fichiers CSV avec toutes les fonctionnalités présentes dans le fichier
'''
...
df.to_csv('/home/guive/Documents/InfoSec/MTP_code/files/flow/17junflow1.csv')
